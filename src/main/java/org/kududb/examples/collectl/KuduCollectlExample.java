...
public class KuduCollectlExample {
  ...
  private static final String KUDU_MASTER = "qing-hadoop-master-srv2" ;
      //System.getProperty("kudu.master_addresses", "qing-hadoop-master-srv2");
  ...
  KuduCollectlExample() {
    ...
    System.out.println("======= builder kudu client");
  }
