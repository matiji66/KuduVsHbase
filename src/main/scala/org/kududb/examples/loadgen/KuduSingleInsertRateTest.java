 ...
 * org.kududb.examples.loadgen.Sample java_sample-1000000 1000000 100w insert
 * 1000s 1ms/p
 * 
 * @author sh04595
 *
 *         java -cp com-pateo-kudu-0.0.1-SNAPSHOT-jar-with-dependencies.jar
 *         org.kududb.examples.loadgen.KuduInsertTest java_sample-10000 10000
 *         false
 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 1; i < count; i++) {
				...
				if (i % step == 0) {
					System.out.println(i + "===========insert cost==========="
							+ (end - start));
				}
			}
			long end = System.currentTimeMillis();

			System.out.println(count + "===========insert cost==========="
					+ (end - start));
