...
/**
 *  java -cp com-pateo-kudu-0.0.1-SNAPSHOT-jar-with-dependencies.jar com.pateo.hbase.api.HBaseSinglePutRateTest test:user 10000
 *  
 * @author sh04595
 *
 */
public class HBaseSinglePutRateTest {
	static Logger logger = LoggerFactory
			.getLogger(HBaseSinglePutRateTest.class);
	...
	private static void put(String tableName, int count) throws IOException,
			InterruptedException {
		...
		long costtime = end - start;
 		...
 		System.out.println(" ========HBaseSinglePutRateTest rate ===" +(costtime/(count + 0.001) ));
	}
	...
	public static Configuration getConfiguration() {
		...
		// "qing-zookeeper-srv1,qing-zookeeper-srv3,qing-zookeeper-srv2");
	...
	private static void testScanAndSimpleComFilter() throws IOException {
		...
		conf.set(HConstants.ZOOKEEPER_QUORUM,
				"qing-hbzk-srv1,qing-hbzk-srv2,qing-hbzk-srv3");
		conf.set(HConstants.ZOOKEEPER_CLIENT_PORT, "2181");
