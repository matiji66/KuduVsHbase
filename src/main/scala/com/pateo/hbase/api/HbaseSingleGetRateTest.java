...
/**
 * java -cp com-pateo-kudu-0.0.1-SNAPSHOT-jar-with-dependencies.jar com.pateo.hbase.api.HbaseSingleGetRateTest test:user 10000  
 * @author sh04595
 *10000 ======== 214921ms 
======== HbaseSingleGetRateTest rate======== 21ms/p
 */
public class HbaseSingleGetRateTest {
	...
	public static void getTest(String tableName, int count) {
		...
		System.out.println("======== HbaseSingleGetRateTest rate======== " + ((end - start)/count) + "ms/p");
	...
	public static void get(String tableName, String row) throws IOException {
		...
		if (Integer.valueOf(row) % 500 == 0) {
			System.err.println( row + "Get SUCCESS: " + row + "\t" + new String(value));
		}
		table.close();
		connection.close();
	}
