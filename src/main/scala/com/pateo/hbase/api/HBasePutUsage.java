...
public class HBasePutUsage {
	static Logger logger = LoggerFactory.getLogger(HBasePutUsage.class);
...
//		ArrayList<Put> arrayList = new ArrayList<Put>();
		...
		for (int i = 1; i < count ; i++) {
			...
			put.addColumn(Bytes.toBytes("f1"), Bytes.toBytes("age"), Bytes.toBytes("value" +i ));
			//arrayList.add(put);
		...
		System.out.println(" ======== HBasePutUsage rate  ======== " + ((end - start)/count) + "ms/p");
	}
